...
const Signup = () => {
  return (
    <div className="flex w-auto h-screen justify-center bg-black items-center">
      <div className=" w-[400px] sm:w-[500px] h-[600px] bg-white rounded-3xl border-2 my-5 border-black">
        <div className=" h-full grid grid-cols-1 justify-items-center items-center">
          <div className=" min-w-max w-1/5 text-center ">
            ...
            <div className="w-full py-3 rounded-full text-2xl font-bold bg-white shadow-black ">
              <span className=" ">SignUp</span>
              <span className="text-[#2ECC40]">Form</span>
            </div>
          </div>
          ...
          <div className="flex flex-col w-3/5 items-center gap-1">
            <div className="w-full flex place-self-start">
              <input type="checkbox" />
              <div className=" ml-2">Create Wallet</div>
            </div>
            <div className=" w-3/5 p-3 text-center  bg-black rounded-md">
              <Link className="text-white" to='/'>Create Account</Link>
            </div>
          </div>
        </div>
      </div>
