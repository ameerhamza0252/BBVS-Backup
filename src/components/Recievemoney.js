...
const Recievemoney = () => {
  return (
    <>
      <div className=" flex flex-col md:flex-row justify-center w-screen sm:h-auto bg-[#212529]" style={{minHeight:"100vh"}}>
        <div className="w-20 grid grid-rows-1 grid-flow-col">
          ...
          <div className="my-[20px] w-40 text-xl">
            <span className="text-white font-semibold ">{"Recieve"}</span>
            <span className="text-[#40fa56] "> Coins</span>
          </div>
        </div>
        <div className=" md:w-3/5 h-full grid grid-cols-1 gap-5 justify-items-center items-center my-10">
          ...
          <div className=" h-auto xl:w-2/4 flex flex-col justify-center gap-6">
            <div className=" flex flex-col">
              <span className="text-white bg-black w-full px-2 rounded-xl p-2">
                Your<span className="text-[#40fa56]"> Address</span> :{" "}
                {"883488"}
              </span>
            </div>
            <div className=" flex flex-col">
            ...
            <div className=" flex flex-col">
              <span className="text-white bg-black w-full px-2 rounded-xl p-2">
                Share this Address with Your Sender to Recive Coins
                {"883488"}
              </span>
            </div>
          </div>

          <div className=" w-40 h-10 bg-white rounded-md items-center flex justify-center font-semibold text-center text-green-600">
            <div>Copy</div>
          </div>
        </div>
      </div>
